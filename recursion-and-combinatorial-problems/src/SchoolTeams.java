...
public class SchoolTeams {
    ...
    public static List<String> allGirlsCombinations = new ArrayList<>();
    public static List<String> allBoysCombinations = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        combineGirls(0, 0);
        combineBoys(0, 0);
        for (String allGirl : allGirlsCombinations) {
            for(String allBoy : allBoysCombinations) {
